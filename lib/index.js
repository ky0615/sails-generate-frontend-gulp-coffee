...
//		} },
		...
		'./tasks/pipeline.coffee': { template: 'tasks/pipeline.coffee' },

		// gulp task configurations (`tasks/config`)
		'./tasks/config/clean.coffee': { template: 'tasks/config/clean.coffee' },
		'./tasks/config/coffee.coffee': { template: 'tasks/config/coffee.coffee' },
		'./tasks/config/concat.coffee': { template: 'tasks/config/concat.coffee' },
		'./tasks/config/copy.coffee': { template: 'tasks/config/copy.coffee' },
		'./tasks/config/cssmin.coffee': { template: 'tasks/config/cssmin.coffee' },
		'./tasks/config/images.coffee': { template: 'tasks/config/images.coffee' },
